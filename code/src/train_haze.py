...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        cv_in = cv2.imread('/scratch/ab9738/pollution_img/data/'+self.filenames[ID]+'.jpg',1)
        cv_out = cv2.imread('/scratch/ab9738/pollution_img/data/'+self.filenames[ID]+'_trans.jpg',0)
